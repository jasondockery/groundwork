...
- S2: line editing keys; walk-the-tree drill | drill: S1 commands
- S3: mv/cp/rm -i; deliberate mistake + recreate | drill: S2 | game: bashcrawl
- S4: history Ctrl+R; man/--help; survival kit | drill: S3
- S5: tmux first contact: split, move, detach, attach | drill: S4
...
- S6: eza (ll/lt), bat; map a cloned repo | drill: S5
- S7: rg smart-case, -t, rgf | drill: S3
- S8: fd; zoxide z | drill: S7
- S9: fzf Ctrl+T / Alt+C; find-search-read loop | drill: S8
- S10: atuin history; build cheatsheet.md from real history | drill: S9
...
- S11: sessions/windows/panes full model | drill: S10
- S12: detach persistence; sesh switcher | drill: S9
- S13: copy mode + scrollback search | drill: S11
- S14: desktop layer: app switch, Raycast snaps (or WM equivalents) | drill: S12
...
- S16: status/diff/add -p; honest messages; explain the S1 ritual | drill: stage-3 build + S13
- S17: branches: create/switch/merge | drill: S16 | game: Learn Git Branching
- S18: log/show/lazygit; history questions | drill: S17
- S19: restore/revert/reset; break 3 ways, recover 3 ways | drill: S18
- S20: first examiner session; gate check | drill: S19 | game: git-game
...
- S21: vimtutor movement; pure motion practice | drill: S16
- S22: verbs: ciw/dd/yy/u | drill: S21 | game: Vim Adventures
- S23: search//, substitute, splits | drill: S22
- S24: LazyVim layer: Space menu, fuzzy open | drill: S23
...
- S26: pipes: wc/sort/uniq/head on the log | drill: S25
- S27: first script + shellcheck | drill: S26
- S28: variables/loops/if; harden workspace opener | drill: S19
- S29: gh: push repo, README | drill: S27-28
- S30: PR flow: branch/push/pr/delta/merge; gate | drill: S17
...
- S31: REPL, variables, types | drill: S30
- S32: if/for — the wall; five loop exercises | drill: S31
- S33: the wall again; lists/dicts; tracebacks bottom-up | drill: S32 blank-file
- S34: functions; extract logstats.py | drill: S32-33 kata
- S35: pytest red->green by hand; gate | drill: S34
...
- S36: files in/out; logstats reads real log.md | drill: S35
- S37: JSON + jq; export log.json, query 3 ways | drill: S26
- S38: sqlite3: CREATE/INSERT/SELECT/WHERE/GROUP BY | drill: S37 | SQLBolt 1-6
- S39: UPDATE/DELETE with SELECT twin; JOIN intro; break rule on a copy | drill: S38
...
- S41: localhost/ports; curl + jq an API | drill: S38
- S42: HTTP from python; status codes; store to db | drill: S39
- S43: smallest local server; serve one endpoint from db | drill: S33
- S44: minimal HTML page over the data | drill: S43
- S45: read one file of a real codebase; 5 sentences; gate | drill: S34
...
- S46: the loop as conscious cycle; reject a plan | drill: S43
- S47: red test by you, green by agent | drill: S35
- S48: visual targets vs prose, same task | drill: S46
- S49: budget: /context /usage; pollute+restart experiment | drill: S47
- S50: risk-naming reviews; gate | drill: S48
...
- S51: AGENTS.md for your app; cold-session test | drill: S50
- S52: plan-first delegation; verify plan vs reality | drill: S49
- S53: security pass; agent attacks own work, you verify | drill: S39
- S54: clone unfamiliar repo; write spec+checklist only | drill: S45
- S55: /rewind, revert, session abandonment; start knowledge base; gate | drill: S19
